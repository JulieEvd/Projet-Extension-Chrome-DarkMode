...
(function (){
    ...
    media.forEach ((mediaItem)=>{
        //ici on définit l'élément mediaItem et on lui donne le même style que plus haut pr revenir à son état initial
        mediaItem.style.filter = "invert(1) hue-rotate(180deg)";

    })
})();  //ici les parenthèse vides, indique que c'est une fonction auto-invoquante = on a appellé la fonction!  (s'exécute immédiatement lorsqu'elle est suivie du jeu de parenthèses () )
